...
public class MainWorkflowTest extends SingleServerInstancePerTest {
    ...
    public void createBasicProfile() throws Exception {
        ...
        appClient.createWidget(1, "{\"orgId\":1, \"width\":1, \"height\":1, \"x\":0, \"y\":0, \"label\":\"Some Text\", \"type\":\"BUTTON\", \"pinType\":\"DIGITAL\", \"pin\":1}");
        appClient.verifyResult(ok(4));
    ...
    public void testValueForPWMPinForStteperIsAccepted() throws Exception {
        clientPair.appClient.createWidget(1, "{\"orgId\":743, \"width\":1, \"height\":1, \"x\":2, \"y\":2, \"label\":\"Some Text 2\", \"type\":\"STEP\", \"pwmMode\":true, \"pinType\":\"DIGITAL\", \"pin\":24}");
        clientPair.appClient.verifyResult(ok(1));
    ...
    public void testNoEnergyDrainForBusinessApps() throws Exception {
        ...
        appClient.createDash("{\"orgId\":2, \"createdAt\":1458856800001, \"name\":\"test board\"}");
        appClient.verifyResult(ok(3));
        ...
        appClient.createWidget(2, "{\"orgId\":3, \"width\":1, \"height\":1, \"x\":2, \"y\":2, \"label\":\"Some Text 2\", \"type\":\"LCD\", \"pinType\":\"DIGITAL\", \"pin\":2}");
        appClient.verifyResult(ok(6));

        appClient.createWidget(2, "{\"orgId\":4, \"width\":1, \"height\":1, \"x\":2, \"y\":2, \"label\":\"Some Text 2\", \"type\":\"LCD\", \"pinType\":\"DIGITAL\", \"pin\":2}");
        appClient.verifyResult(ok(7));

        appClient.createWidget(2, "{\"orgId\":5, \"width\":1, \"height\":1, \"x\":2, \"y\":2, \"label\":\"Some Text 2\", \"type\":\"LCD\", \"pinType\":\"DIGITAL\", \"pin\":2}");
        appClient.verifyResult(ok(8));

        appClient.createWidget(2, "{\"orgId\":6, \"width\":1, \"height\":1, \"x\":2, \"y\":2, \"label\":\"Some Text 2\", \"type\":\"LCD\", \"pinType\":\"DIGITAL\", \"pin\":2}");
        appClient.verifyResult(ok(9));

        appClient.createWidget(2, "{\"orgId\":7, \"width\":1, \"height\":1, \"x\":2, \"y\":2, \"label\":\"Some Text 2\", \"type\":\"BUTTON\", \"pinType\":\"DIGITAL\", \"pin\":2}");
    ...
    public void testAddAndRemoveTabs() throws Exception {
        ...
        clientPair.appClient.createWidget(1, "{\"orgId\":101, \"width\":1, \"height\":1, \"x\":15, \"y\":0, \"tabId\":1, \"label\":\"Some Text\", \"type\":\"BUTTON\", \"pinType\":\"DIGITAL\", \"pin\":18}");
        clientPair.appClient.verifyResult(ok(4));

        clientPair.appClient.createWidget(1, "{\"orgId\":102, \"width\":1, \"height\":1, \"x\":5, \"y\":0, \"tabId\":0, \"label\":\"Some Text\", \"type\":\"BUTTON\", \"pinType\":\"DIGITAL\", \"pin\":17}");
    ...
    public void testAddAndUpdateTabs() throws Exception {
        ...
        clientPair.appClient.createWidget(1, "{\"orgId\":102, \"width\":1, \"height\":1, \"x\":5, \"y\":0, \"tabId\":2, \"label\":\"Some Text\", \"type\":\"BUTTON\", \"pinType\":\"DIGITAL\", \"pin\":17}");
        clientPair.appClient.verifyResult(ok(5));
        ...
        clientPair.appClient.updateWidget(1, "{\"orgId\":100, \"width\":1, \"height\":1, \"x\":0, \"y\":0, \"tabs\":[{\"label\":\"tab 1\"}, {\"label\":\"tab 2\"}], \"type\":\"TABS\"}");
        clientPair.appClient.verifyResult(ok(2));
    ...
    public void testDashCommands() throws Exception {
        clientPair.appClient.updateDash("{\"orgId\":10, \"name\":\"test board update\"}");
        clientPair.appClient.verifyResult(illegalCommand(1));

        clientPair.appClient.createDash("{\"orgId\":10, \"name\":\"test board\"}");
        clientPair.appClient.verifyResult(ok(2));
    ...
    public void testHardwareChannelClosedOnDashRemoval() throws Exception {
        ...
        Path pinReportingDataPath12 = Paths.get(tempDir, "data", username,
                ReportingDiskDao.generateFilename(0, PinType.DIGITAL, (short) 8, GraphGranularityType.DAILY));
        Path pinReportingDataPath13 = Paths.get(tempDir, "data", username,
                ReportingDiskDao.generateFilename(0, PinType.VIRTUAL, (short) 9, GraphGranularityType.DAILY));
    ...
    public void testSmsWorks() throws Exception {
        ...
        //adding sms widget
        clientPair.appClient.createWidget(1, "{\"orgId\":432, \"width\":1, \"height\":1, \"to\":\"3809683423423\", \"x\":0, \"y\":0, \"type\":\"SMS\"}");
        clientPair.appClient.verifyResult(ok(1));
    ...
    public void testPlayerUpdateWorksAsExpected() throws Exception {
        clientPair.appClient.createWidget(1, "{\"type\":\"PLAYER\",\"orgId\":99, \"pin\":99, \"pinType\":\"VIRTUAL\", " +
    ...
    public void testSendHardwareCommandToNotActiveDashboard() throws Exception {
        clientPair.appClient.createDash("{\"orgId\":2,\"name\":\"My Dashboard2\"}");
