...
public class ProductAPITest extends APIBaseTest {
    ...
    public void testAddMetaDataFieldInChildDevices() throws Exception {
        ...
        newDevice.metaFields[0] = new TextMetaField(textMetaField.id, textMetaField.name, textMetaField.role, false, false, null, "My updated value");
        ...
        product.metaFields = new MetaField[] {
                ...
                new NumberMetaField(2, "New metafield", Role.ADMIN, false, false, null, 0, 1000, 123)
        };
    ...
    public void testUpdateMetaDataFieldInChildDevices() throws Exception {
        ...
        product.metaFields[0] = new TextMetaField(1, "Me updated test metafield", Role.USER, false, false, null, "Default Device");
    ...
    public void testUpdateContactMetaDataFieldInChildDevices() throws Exception {
        ...
        product.metaFields[0] = new ContactMetaField(1, "Farm of Smith", Role.ADMIN, false, false, null, "Tech Support",
