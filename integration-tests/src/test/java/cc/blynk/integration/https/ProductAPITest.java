...
public class ProductAPITest extends APIBaseTest {
    ...
    public void testAddMetaDataFieldInChildDevices() throws Exception {
        ...
        newDevice.metaFields[0] = new TextMetaField(textMetaField.id, textMetaField.name, textMetaField.role, false, false, false, null, "My updated value");
    ...
    public void testUpdateMetaDataFieldInChildDevices() throws Exception {
        ...
        product.metaFields[0] = new TextMetaField(1, "Me updated test metafield", Role.USER, false, false, false, null, "Default Device");
