...
import OTA, { Edit as OTAEdit } from './scenes/OTA';
      ...
      <LocaleProvider locale={enUS}>
        <Router history={history}>
          <Route component={Book}>
            ...
            <Route path="/book/device-auth-token"
                   component={Book.DeviceAuthToken}/>
            <Route path="/book/content-editable"
                   component={Book.ContentEditable}/>
          ...
          <Route component={Connection}>
            <Route component={Layout}>
              <Route component={UserLayout}
                     onEnter={RouteAuthorizedOnly(store)}>
                ...
                <Route path="/ota/create" component={OTAEdit}/>
                ...
                <Route path="/organizations/create/:tab"
                       component={Organizations.Create}/>
                <Route path="/organizations/edit/:id"
                       component={Organizations.Edit}/>
                <Route path="/organizations/edit/:id/:tab"
                       component={Organizations.Edit}/>
                <Route path="/organizations/:id"
                       component={Organizations.Details}/>
                <Route path="/organizations/:id/:tab"
                       component={Organizations.Details}/>
                <Route component={ProductPreload}>
                  <Route path="/products" component={ProductsIndex}/>
                  <Route path="/products/create" component={ProductCreate}/>
                  <Route path="/products/create/:tab"
                         component={ProductCreate}/>
                  <Route path="/products/edit/:id" component={ProductEdit}/>
                  <Route path="/products/edit/:id/:tab"
                         component={ProductEdit}/>
                  <Route path="/products/clone/:id" component={ProductClone}/>
                  <Route path="/products/clone/:id/:tab"
