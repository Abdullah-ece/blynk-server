      ...
      <div>
        ...
        <div className="terms-and-conditions-wrapper">
          ...
          <div className="chapter">
            ...
            <div className="chapter-text-block">
              <ul><li>In connection with your use of the Service, you agree and represent as follows:</li><li>You are of legal age (at least 13 years of age) and are otherwise capable of forming a legally binding contract.</li><li>You have authority to bind the legal entity (the Blynk Client) with which you are associated.</li><li>You expressly agree to be contacted via Email, SMS, text messaging and Push Notifications by us, and third parties, if relevant, regarding our Services.</li><li>You hereby grant us permission to email you or display your profile and such other information as may be supplied by you for public display as you designate.</li><li>By using the Service, you are granting us (and any service providers or Providers used by us) permission to access your account and those messages, data, information, text, graphics, audio, video or other material and content of any kind posted/uploaded/transmitted to or through the Service using your account, to process and submit said material to End Users.</li></ul>
            </div>
            <div className="chapter-text-block">Except as set forth below, Blynk will use its registered developer account with each Provider and will be the sole publisher of your Applications with any mobile platform provider including, but not limited to, the Apple Inc. ("Apple") App Store™ and Google Play™ Mobile platform providers are referred to in this document as "Providers." You may use your own Account to self-publish an Application developed using our Web Site and/or Service with any such Providers only with prior written permission from Blynk, in which case additional fees may apply.  </div>
          </div>
          <div className="chapter">
            <div className="chapter-title">
              Devices
            </div>
            <div className="chapter-text-block"> You are solely responsible and liable for your Devices, and for supporting the Devices. On each Device in which you use the Blynk Service, you shall prominently display and comply with a privacy policy on such Device that includes a full, accurate and clear disclosure regarding Blynk's collection, use and distribution of personal information collected via the Blynk Service in accordance with our Privacy Policy. </div>
            <div className="chapter-text-block"> You represent and warrant that your Device will not: (i) violate any third-party right, including any copyright, trademark, patent, trade secret, moral right, privacy right, right of publicity, or any other intellectual property or proprietary right; (ii) violate any laws or regulations (including any privacy laws) or any obligations or restrictions imposed by any third party; (iii) be harassing, abusive, tortious, threatening, harmful, invasive of another's privacy, vulgar, defamatory, false, intentionally misleading, trade libelous, pornographic, obscene, or patently offensive, or promote racism, bigotry, hatred, or physical harm of any kind against any group or individual, or be otherwise objectionable; (iv) be harmful to minors in any way; (v) contain any computer viruses, worms, or any software intended to damage or alter a computer system or data; (vi) send unsolicited or unauthorized advertising, promotional materials, junk mail, spam, text messages, chain letters, pyramid schemes, or any other form of duplicative or unsolicited messages, whether commercial or otherwise; or (vii) offer or promote services that may be damaging to, disparaging of, or otherwise detrimental to Blynk or its licensors, licensees, affiliates and partners. </div>
            <div className="chapter-text-block">
              Blynk will have the right, in its sole discretion, to refuse to permit your use of the Blynk Services with a particular Device. Unless Blynk states otherwise, such rejection will not terminate this Agreement with respect to any other Device. Blynk will have no liability to you for such refusal.</div>
          </div>
          <div className="chapter">
            <div className="chapter-title">
              Monitoring
            </div>
            <div className="chapter-text-block">You agree to provide us with access to your Device and other materials related to your use of the Blynk Service as reasonably requested by us to verify your compliance with this Agreement. </div>
          </div>
          <div className="chapter">
            <div className="chapter-title">
              Unauthorized Applications
            </div>
            <div className="chapter-text-block">You understand that the Blynk Services are not designed, intended, authorized or warranted to be suitable for use in the following "Unauthorized Applications": life support applications, devices or systems, the operation of nuclear facilities; aircraft navigation systems; aircraft communication systems; air traffic control; direct life support machines; weapons systems; military or space equipment requiring radiation hardened components; and Enhanced 911 or E911 emergency calling system. You warrant that you will not use the Blynk Properties for Unauthorized Applications. </div>
          </div>
          <div className="chapter">
            <div className="chapter-title">
              Ownership
            </div>
            <div className="chapter-text-block">As between you and Blynk, Blynk owns all right, title and interest in and to the Blynk Services. Except for the license granted (License Grant), this Agreement grants you no right, title, or interest in any intellectual property owned or licensed by us, including the Blynk Service, Software and Brand Features (as defined below). You agree to abide by all applicable proprietary rights laws and other laws, as well as any additional copyright notices and restrictions contained in this Agreement. We claim no ownership or control over your Device or the content sent, posted or displayed through your Device, except for any Blynk Services therein. </div>
          </div>
          <div className="chapter">
            <div className="chapter-title">
              Brand Features
            </div>
            <div className="chapter-text-block">We grant you a limited, non-exclusive license to display our name, logos and domain names (collectively, "Brand Features") to promote and advertise your use of the Blynk Services in accordance with this section. When you promote your Device, you must not imply that your Device is created or endorsed in any manner by Blynk, although you may state facts (e.g., the Device is used with the Blynk Service). You agree, however, not to remove, obscure, distort, or alter any of our Brand Features or display our Brand Features in any way that is misleading, defamatory, infringing, libelous, disparaging, obscene, or otherwise objectionable to Blynk. All use by you of the Brand Features (including any goodwill associated therewith) will inure to the benefit of Blynk. At no time during or after the term of this Agreement will you challenge or assist others to challenge the Brand Features (except to the extent such restriction is prohibited by law) or the registration thereof by Blynk, nor will you attempt to register any trademarks that are confusingly similar in any way to any Brand Features. You must submit to us a copy or image of any media release or advertising that includes any the Brand Features by emailing us at iot@blynk.cc
          ...
          <div className="chapter">
            ...
            <div className="chapter-text-block">
              Certain services and functionalities available via the Blynk Service are free of charge. However, Blynk may, in its sole discretion charge fees in connection with certain services, such as extending the current services functionality and limiting number of requests that can be sent from Device(s) to the Cloud.</div>
            <div className="chapter-text-block">Publishing an App requires a valid credit card. If you prefer to pay by wire transfer or any alternate methods, please contact Blynk's support team, as exceptions may be made from time to time for an alternate method of payment with Blynk.

            </div>
            <div className="chapter-text-block">
              You will be responsible for payment of the applicable fee for the Blynk Services (each, a "Service Subscription Fee") at the time you create your Account and select your monthly or annual plan (each, a "Subscription Renewal Date"). Except as set forth herein, all fees for the Blynk Services are non-refundable. Your subscription will continue indefinitely until terminated in accordance with the terms herein. After your initial subscription period, and again after any subsequent subscription period, your subscription will automatically commence on the first day following the end of such period (each, a "Subscription Renewal Date") and continue for an equivalent period, at Blynk's then-current price for such subscription. You agree that your Account will be subject to this automatic renewal feature unless you cancel your subscription at least thirty (30) days prior to the Renewal Commencement Date. If you cancel your subscription, you will not be eligible for a prorated refund of any portion of the subscription fee paid for the then-current subscription period.

            </div>
            <div className="chapter-text-block">All fees are exclusive of all taxes, levies, or duties imposed by taxing authorities, and you shall be responsible for payment of all such taxes, levies, or duties, excluding only United States (federal or state) taxes on Blynk income.

            </div>
            <div className="chapter-text-block">

              Blynk will use commercially reasonable efforts to have the Application approved by the applicable Providers. Although there is a high likelihood of approval, we do not and cannot guarantee acceptance. If your Application is denied by the appropriate Provider, you will be notified. However, there are no refunds under any circumstances.

            </div>
            <div className="chapter-text-block">If invoiced, payment is due upon receipt.

            </div>
            <div className="chapter-text-block">Prices for the Service are subject to change upon 30 days' notice. Such notice may be provided at any time by posting the changes to the Site or through the Service itself. </div>
            <div className="chapter-text-block">You agree to pay all fees or charges to your account in accordance with the applicable fees, charges and billing terms in effect at the time a fee or charge is due and payable.
          ...
          <div className="chapter">
            ...
            <div className="chapter-text-block">We respect the rights of third party creators and content owners and expect that you will do the same. Given the nature of the Service and the volume of information submitted, we cannot and do not monitor all of the Materials (defined below) posted or transmitted by you and other third-party information providers via the Service. You expressly agree that we: (a) will not be liable for Materials and (b) reserve the right to review, reject, delete, remove, modify, or edit any Materials at any time for any reason, without liability and without notice to you. We reserve the right, but are not obligated, to remove User Content from the Service for any reason, including User Content that we believe violates these Terms or our Acceptable Use Policy below. </div>
            <div className="chapter-text-block">It is our policy to respond to all claims of intellectual property infringement. We will promptly investigate notices of alleged infringement and will take appropriate actions required under the Digital Millennium Copyright Act, Title 17, United States Code, Section 512(c)(2) ("DMCA") and other applicable intellectual property laws. Pursuant to the DMCA, notifications of claimed copyright infringement should be sent to a Service Provider's Designated Agent. Notification must be submitted to the following Designated Agent for this web site: iot@blynk.cc
          ...
          <div className="chapter">
            ...
            <div className="chapter-text-block">We are not responsible for any errors or delays or other technical problems beyond our reasonable control.</div>
          </div>
          <div className="chapter">
            <div className="chapter-title">
              Termination and Cancellation
            </div>
            <div className="chapter-text-block">You are solely responsible for canceling your subscription. Cancellation requests must be submitted in writing to iot@blynk.cc or canceled at the payment service . Cancellations by phone or sent to any other email address will not be considered valid. If you cancel a subscription, we will still provide access to your account as well as basic account functions during the subscription term. For example, if you subscribed to a one-event app on March 1st and then cancelled the subscription on November 1st, you would still have access to the information for the App through February 28th.

            </div>
            <div className="chapter-text-block">After you cancel the Service, your Dedicated Cloud Server will be turned off within 14 (fourteen) calendar days. All of the Devices will loose connection to the Dedicated Cloud Server. All the data stored on the Dedicated Cloud Server will be deleted without prior notice. If you need to export the data you need to deliver a written notice addressed to iot@blynk.cc. You shall be responsible for ensuring delivery of the notice to us.
            </div>
            <div className="chapter-text-block">After you cancel the Service, Client apps will remain in the App Store and Google Play. If you need to remove the Apps, you need to deliver a written notice addressed to iot@blynk.cc. You shall be responsible for ensuring delivery of the notice to us. After the Service is canceled, Blynk may remove Apps without prior notice
            </div>
            <div className="chapter-text-block">

              If you desire to cancel your entire account, please contact us at iot@blynk.cc. In addition to cancelling your account you may also delete individual Apps, in which case underlying app data may not be recoverable." We reserve the right in our sole discretion, and without any prior notice, to terminate your access to the Service for any reason, including your breach of these Terms of Service, the terms and conditions of any service for which you may have registered, or a violation of the rights or another User or the law. You may unsubscribe from any further communication from us at any time by delivering a written notice addressed to iot@blynk.cc. You shall be responsible for ensuring delivery of the notice to us.</div>
          </div>
          <div className="chapter">
            <div className="chapter-title">
              Transfer of Ownership
            </div>
            <div className="chapter-text-block">In the case when Blynk is no longer capable of providing the Services, Blynk will issue an official notice to it's Clients notifying about this matter. Blynk will apply all reasonable efforts to transfer products and services under Client's ownership. These actions are limited to Cloud Server migration, data migration and transferring Applications to Client's developer account.    </div>
            <div className="chapter-text-block">If you need to transfer the ownership, you need to deliver a written reply addressed to iot@blynk.cc within 30(thirty) days from the initial notice. You shall be responsible for ensuring delivery of the notice to us.  Blynk is not responsible for any Client's expenses and losses involved in any process associated with the Transfer of Ownership process.
            </div>
            <div className="chapter-text-block">Blynk will not disclose source-code for the Applications. </div>
          </div>
          <div className="chapter">
            <div className="chapter-title">
              Arbitration
            </div>
            <div className="chapter-text-block">If any dispute, claim or controversy arises under this Agreement, such dispute shall be resolved by binding arbitration before a single arbitrator in accordance with the Commercial Arbitration Rules of the American Arbitration Association ("AAA") then pertaining, except where such rules conflict with this section, in which case this section shall control. Any court with jurisdiction shall enforce this section and enter judgment on any award. The arbitrator shall be selected within twenty (20) Business Days from commencement of the arbitration from the AAA's National Roster of Arbitrators pursuant to agreement or through selection procedures administered by the AAA. Within forty-five (45) days of initiation of arbitration, the Parties shall reach agreement upon and thereafter follow procedures, including limits on discovery, assuring that the arbitration will be concluded and the award rendered within no more than eight (8) months from selection of arbitrators or, failing agreement, procedures meeting such time limits will be designed by the AAA and adhered to by the Parties. The arbitration shall be held in New York City, New York and the arbitrators shall apply the substantive law of the State of New York, except that the interpretation and enforcement of this arbitration provision shall be governed by the Federal Arbitration Act.</div>
          </div>
          <div className="chapter">
            <div className="chapter-title">
