...
public class DataStreamValuesUpdateCorrectTest {
    ...
    public void testHas1Pin() {
        ...
        rgb.dataStreams[0] = new DataStream(0, (byte) 0, false, false, PinType.VIRTUAL, null, 0, 255, null, null);
        rgb.dataStreams[1] = new DataStream(1, (byte) 1, false, false, PinType.VIRTUAL, null, 0, 255, null, null);
        rgb.dataStreams[2] = new DataStream(2, (byte) 2, false, false, PinType.VIRTUAL, null, 0, 255, null, null);
        ...
        rgb = new RGB();
        rgb.dataStreams = new DataStream[3];
        rgb.dataStreams[0] = new DataStream(0, (byte) 4, false, false, PinType.VIRTUAL, null, 0, 255, null, null);
        rgb.dataStreams[1] = new DataStream(1, (byte) 4, false, false, PinType.VIRTUAL, null, 0, 255, null, null);
        rgb.dataStreams[2] = new DataStream(2, (byte) 4, false, false, PinType.VIRTUAL, null, 0, 255, null, null);
