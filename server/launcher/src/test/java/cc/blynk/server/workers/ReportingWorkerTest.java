...
public class ReportingWorkerTest {
    ...
    public void testFailure() {
        ...
        AggregationKey aggregationKey = new AggregationKey(1, 0, PinType.ANALOG, (short) 1, ts);
    ...
    public void testStore() {
        ...
        AggregationValue aggregationValue = new AggregationValue();
        aggregationValue.update(100);
        AggregationKey aggregationKey2 = new AggregationKey(1, 0, PinType.ANALOG, (short) 1, ts - 1);
        AggregationValue aggregationValue2 = new AggregationValue();
        aggregationValue2.update(150.54);
        AggregationKey aggregationKey3 = new AggregationKey(2, 0, PinType.ANALOG, (short) 2, ts);
        ...
        assertTrue(Files.exists(Paths.get(reportingFolder, "test",
                generateFilename(PinType.ANALOG, (short) 1, GraphGranularityType.HOURLY))));
        assertTrue(Files.exists(Paths.get(reportingFolder, "test2",
                generateFilename(PinType.ANALOG, (short) 2, GraphGranularityType.HOURLY))));

        assertTrue(map.isEmpty());

        ByteBuffer data = reportingDaoMock.getByteBufferFromDisk(0, PinType.ANALOG, (short) 1, 2, GraphGranularityType.HOURLY, 0);
        assertNotNull(data);
        ...
        data = reportingDaoMock.getByteBufferFromDisk(0, PinType.ANALOG, (short) 2, 1, GraphGranularityType.HOURLY, 0);
        assertNotNull(data);
    ...
    public void testStore2() {
        ...
        AggregationValue aggregationValue2 = new AggregationValue();
        aggregationValue2.update(150.54);
        AggregationKey aggregationKey3 = new AggregationKey( 1, 0, PinType.ANALOG, (short) 1, ts - 2);
        AggregationValue aggregationValue3 = new AggregationValue();
        aggregationValue3.update(200);
        ...
        //take less
        ByteBuffer data = reportingDaoMock.getByteBufferFromDisk(0, PinType.ANALOG, (short) 1, 1, GraphGranularityType.HOURLY, 0);
        assertNotNull(data);
        assertEquals(16, data.capacity());
        ...
        //take more
        data = reportingDaoMock.getByteBufferFromDisk(0, PinType.ANALOG, (short) 1, 24, GraphGranularityType.HOURLY, 0);
        assertNotNull(data);
    ...
    public void testDeleteCommand() {
        ...
        assertTrue(Files.exists(Paths.get(reportingFolder,  generateFilename(PinType.ANALOG, (short) 1, GraphGranularityType.HOURLY))));
        assertTrue(Files.exists(Paths.get(reportingFolder, "test2", generateFilename(PinType.ANALOG, (short) 2, GraphGranularityType.HOURLY))));

        User user = new User();
        user.email = "test";

        new ReportingDiskDao(reportingFolder, true).delete(0, PinType.ANALOG, (short) 1);
        assertFalse(Files.exists(Paths.get(reportingFolder,  generateFilename(PinType.ANALOG, (short) 1, GraphGranularityType.HOURLY))));
    }
