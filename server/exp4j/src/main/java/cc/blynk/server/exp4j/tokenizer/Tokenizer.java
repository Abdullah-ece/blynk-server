...
import cc.blynk.server.exp4j.exceptions.UnknownFunctionOrVariableException;
        ...
        if (Character.isDigit(ch) || ch == '.') {
            if (lastToken != null) {
                ...
                if (type == Token.TOKEN_NUMBER) {
                    throw new IllegalArgumentException("Unable to parse char '"
                            + ch + "' (Code:" + (int) ch + ") at [" + pos + "]");
