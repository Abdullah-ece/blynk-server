...
public final class MobileSetWidgetPropertyLogic {
    ...
    public static void messageReceived(ChannelHandlerContext ctx, User user, StringMessage message) {
        ...
        if (widgetProperty == null) {
            log.debug("Unsupported property for setProperty command. {}.", property);
            throw new JsonException("Unsupported property for setProperty command.");
        }
        ...
        if (!widget.setProperty(widgetProperty, propertyValue)) {
            ...
            throw new JsonException("Property with value not supported.");
        }
